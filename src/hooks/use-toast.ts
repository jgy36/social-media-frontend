// src/hooks/use-toast.ts - React Native version
...
function toast(opts: ToastOptions) {
  ...
  // For React Native, use native toast on Android, Alert on iOS
  if (Platform.OS === 'android') {
    ...
    Alert.alert(title?.toString() || 'Notification', message.toString())
  }
